...
public class TnVaController {
    ...
    private ResultDTO<DbQrsDTO> queryDeviceDeploy_exp() {
        ...
        int idx = 0;
        recs.add(new TnDeviceDeployDTO(100,"上地三街10号", lng + idx*0.01, lat + idx*0.01));
        idx++;
        recs.add(new TnDeviceDeployDTO(100,"西三旗", lng + idx*0.01, lat + idx*0.01));
        idx++;
        recs.add(new TnDeviceDeployDTO(100,"清河中街", lng + idx*0.01, lat + idx*0.01));
        idx++;
        recs.add(new TnDeviceDeployDTO(100,"北土城路", lng + idx*0.01, lat + idx*0.01));
        idx++;
        recs.add(new TnDeviceDeployDTO(100,"中关村大街", lng + idx*0.01, lat + idx*0.01));
        idx++;
        data.setRecs(recs);
        dto.setData(data);
        return dto;
