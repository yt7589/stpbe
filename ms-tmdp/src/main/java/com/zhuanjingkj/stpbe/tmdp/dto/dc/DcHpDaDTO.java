...
public class DcHpDaDTO extends BaseDTO {
    ...
    @JSONField(name = "dit")
    List<DcHpIlTrendDTO> dit; //违章趋势
    @JSONField(name = "drt")
    List<DcHpRgTrendDTO> drt; //识别量趋势
    ...
    public List<DcHpIlTrendDTO> getDit() {
        return dit;
    }

    public void setDit(List<DcHpIlTrendDTO> dit) {
        this.dit = dit;
    }

    public List<DcHpRgTrendDTO> getDrt() {
        return drt;
    }

    public void setDrt(List<DcHpRgTrendDTO> drt) {
        this.drt = drt;
    }
}
