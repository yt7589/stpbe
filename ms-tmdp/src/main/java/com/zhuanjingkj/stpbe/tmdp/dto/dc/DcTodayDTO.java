 ...
 * 今日概况
 */
public class DcTodayDTO extends BaseDTO {
    ...
    public DcTodayDTO(Integer vehicle, Integer vehicle_city, Integer vehicle_town, Integer vehicle_city_act, Integer device_online) {
