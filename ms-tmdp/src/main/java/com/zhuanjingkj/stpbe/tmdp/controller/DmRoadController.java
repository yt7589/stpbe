...
public class DmRoadController {
    ...
    private ResultDTO<DbQrsDTO> queryRoad_exp() {
        ...
        recs.add(new DmRoadSectionDTO(101,"海淀区上地八街12号","海淀区>上地",116.3,40.3));
        recs.add(new DmRoadSectionDTO(102,"海淀区上地八街13号","海淀区>上地",116.4,40.4));
        recs.add(new DmRoadSectionDTO(103,"海淀区上地八街14号","海淀区>上地",116.5,40.5));
        recs.add(new DmRoadSectionDTO(104,"海淀区上地八街15号","海淀区>上地",116.6,40.2));
        recs.add(new DmRoadSectionDTO(105,"海淀区上地八街16号","海淀区>上地",116.7,40.3));
        recs.add(new DmRoadSectionDTO(106,"海淀区上地八街17号","海淀区>上地",116.8,40.4));
        recs.add(new DmRoadSectionDTO(107,"海淀区上地八街12号","海淀区>上地",116.3,40.3));
        recs.add(new DmRoadSectionDTO(108,"海淀区上地八街18号","海淀区>上地",116.9,40.6));
        recs.add(new DmRoadSectionDTO(109,"海淀区上地八街12号","海淀区>上地",116.1,40.5));
        recs.add(new DmRoadSectionDTO(100,"海淀区上地八街18号","海淀区>上地",116.3,40.7));
        data.setRecs(recs);
        dto.setData(data);
        return dto;
    }
