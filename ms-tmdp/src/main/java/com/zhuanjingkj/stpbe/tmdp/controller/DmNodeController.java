...
public class DmNodeController {
    ...
    private ResultDTO<DbQrsDTO> queryNode_exp() {
        ...
        recs.add(new DmNodeDTO(102,"北京市","海淀区上地八街1号位","海淀>上地",116.02,40.23));
        recs.add(new DmNodeDTO(103,"北京市","海淀区上地八街3号位","海淀>上地",116.013,40.33));
        recs.add(new DmNodeDTO(104,"北京市","海淀区上地八街5号位","海淀>上地",116.0214,40.43));
        recs.add(new DmNodeDTO(105,"北京市","海淀区上地八街7号位","海淀>上地",116.0145,40.53));
        recs.add(new DmNodeDTO(106,"北京市","海淀区上地八街9号位","海淀>上地",116.046,40.630));
        recs.add(new DmNodeDTO(107,"北京市","海淀区上地八街11号位","海淀>上地",116.057,40.73));
        recs.add(new DmNodeDTO(108,"北京市","海淀区上地八街13号位","海淀>上地",116.0328,40.83));
        recs.add(new DmNodeDTO(109,"北京市","海淀区上地八街15号位","海淀>上地",116.215,40.93));
