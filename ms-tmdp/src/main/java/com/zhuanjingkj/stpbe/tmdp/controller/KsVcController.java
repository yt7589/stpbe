...
public class KsVcController {
    ...
    private ResultDTO<DbQrsDTO> queryVcSfvs_exp() {
        ...
        recs.add(new KsVcSfvsDTO(101, "北京市海淀区西二旗街道19号",116.0185,40.0495, 1,"京A-XA001"));
        recs.add(new KsVcSfvsDTO(101, "北京市海淀区上地街道39号",116.0285,40.1495, 2,"京A-XA002"));
        recs.add(new KsVcSfvsDTO(101, "北京市海淀区西直门街道29号",116.0385,40.24295, 4,"京A-XA003"));
        recs.add(new KsVcSfvsDTO(101, "北京市海淀区知春路街道109号",116.0485,40.3495, 5,"京A-XA004"));
        recs.add(new KsVcSfvsDTO(101, "北京市朝阳区东湖区99号",116.0585,40.4495, 6,"京A-XA005"));
        recs.add(new KsVcSfvsDTO(101, "北京市昌平区北七家街道21号",116.0685,40.5495, 9,"京A-XA006"));
        recs.add(new KsVcSfvsDTO(101, "北京市望京街道59号",116.0785,40.6495, 3,"京A-XA007"));
        recs.add(new KsVcSfvsDTO(101, "北京市海淀区回龙观39号",116.0885,40.7495, 6,"京A-XA008"));
        data.setRecs(recs);
        dto.setData(data);
        return dto;
    }
    ...
    private ResultDTO<DbQrsDTO> queryVcLsvs_exp() {
        ...
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市海淀区西二旗街道19号","2020-12-21 18:02:57","京A-XA001",1));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市海淀区上地街道39号","2020-12-22 18:02:57","京A-XA002",2));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市海淀区西直门街道29号","2020-12-23 18:02:57","京A-XA003",3));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市海淀区知春路街道109号","2020-12-29 18:02:57","京A-XA004",4));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市朝阳区东湖区99号","2020-12-28 18:02:57","京A-XA005",5));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市昌平区北七家街道21号","2020-12-27 18:02:57","京A-XA006",6));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市海淀区回龙观39号","2020-12-26 18:02:57","京A-XA007",7));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市望京街道59号","2020-12-25 18:02:57","京A-XA008",8));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市海淀区回龙观39号","2020-12-24 18:02:57","京A-XA009",9));
        recs.add(new KsVcLsvsDTO(10,10,101,"北京市海淀区回龙观39号","2020-12-22 18:02:57","京A-XA010",10));
        data.setRecs(recs);
        dto.setData(data);
        return dto;
    }
