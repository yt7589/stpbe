...
import com.zhuanjingkj.stpbe.tvis_server.wxs2102.service.impl.TsXaidrService;
...
@CrossOrigin(origins = "*")
@RequestMapping("")
public class TsXaidrController {
    ...
    @Autowired
    private TsXaidrService tsXaidrService;
    ...
    public Map<String, Object> functionDetect(
        ...
        JSONArray rst = tsXaidrService.detectXaidrImage(data);
